...
class ApplyPromptService(
    ...
    fun showPrompt(player: Player, kind: EditorApplyKind, applyTimeoutSeconds: Int) {
        val subtitleKey = when (kind) {
            ...
            EditorApplyKind.DEATH_PROTECTION_RANDOM_TELEPORT_DIAMETER,
            EditorApplyKind.FOOD_NUTRITION,
            EditorApplyKind.FOOD_SATURATION,
            EditorApplyKind.CONSUMABLE_RANDOM_TELEPORT_DIAMETER -> MessageKey.EDIT_APPLY_PROMPT_SUBTITLE_AMOUNT
            EditorApplyKind.CONSUMABLE_CONSUME_SECONDS -> MessageKey.EDIT_APPLY_PROMPT_SUBTITLE_CONSUME_SECONDS
            EditorApplyKind.CONSUMABLE_SOUND -> MessageKey.EDIT_APPLY_PROMPT_SUBTITLE_SOUND
            EditorApplyKind.CONSUMABLE_REMOVE_EFFECT_ADD -> MessageKey.EDIT_APPLY_PROMPT_SUBTITLE_EFFECT
            EditorApplyKind.CONSUMABLE_APPLY_EFFECT_ADD -> MessageKey.EDIT_APPLY_PROMPT_SUBTITLE_POTION_EFFECT
        }
