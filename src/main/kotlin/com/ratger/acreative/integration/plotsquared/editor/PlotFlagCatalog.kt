    ...
    companion object {
        ...
        val definitions: List<PlotFlagDefinition> = listOf(
            ...
            preset(
                ...
                options = listOf(
                    PlotFlagOption("Не задана", "none"),
                    PlotFlagOption("13", "minecraft:music_disc_13"),
                    PlotFlagOption("Cat", "minecraft:music_disc_cat"),
                    PlotFlagOption("Blocks", "minecraft:music_disc_blocks"),
                    PlotFlagOption("Chirp", "minecraft:music_disc_chirp"),
                    PlotFlagOption("Far", "minecraft:music_disc_far"),
                    PlotFlagOption("Mall", "minecraft:music_disc_mall"),
                    PlotFlagOption("Mellohi", "minecraft:music_disc_mellohi"),
                    PlotFlagOption("Stal", "minecraft:music_disc_stal"),
                    PlotFlagOption("Strad", "minecraft:music_disc_strad"),
                    PlotFlagOption("Ward", "minecraft:music_disc_ward"),
                    PlotFlagOption("11", "minecraft:music_disc_11"),
                    PlotFlagOption("Wait", "minecraft:music_disc_wait"),
                    PlotFlagOption("Otherside", "minecraft:music_disc_otherside"),
                    PlotFlagOption("Pigstep", "minecraft:music_disc_pigstep"),
                    PlotFlagOption("5", "minecraft:music_disc_5"),
                    PlotFlagOption("Relic", "minecraft:music_disc_relic"),
                    PlotFlagOption("Creator", "minecraft:music_disc_creator"),
                    PlotFlagOption("Creator Music Box", "minecraft:music_disc_creator_music_box"),
                    PlotFlagOption("Precipice", "minecraft:music_disc_precipice")
                )
            ),
            ...
            booleanPreset("tamed-attack", "Убийство питомцев", "Управляет атакой гостей по прирученным животным.", "minecraft:wolf_armor", "TamedAttackFlag", "Разрешить", "Запретить"),
            ...
            booleanPreset("hostile-interact", "Взаимодействие с монстрами", "Управляет взаимодействием гостей с монстрами.", "minecraft:creaking_spawn_egg", "HostileInteractFlag", "Разрешить", "Запретить"),
            ...
            booleanPreset("mob-place", "Спавн мобов", "Управляет спавном существ гостями на участке.", "minecraft:spawner", "MobPlaceFlag", "Разрешить", "Запретить"),
            ...
            booleanPreset("vehicle-break", "Ломать транспорт", "Управляет разрушением транспорта гостями.", "minecraft:iron_axe", "VehicleBreakFlag", "Разрешить", "Запретить"),
            number("vehicle-cap", "Лимит транспорта", "Задаёт лимит транспорта на участке.", "minecraft:rail", "VehicleCapFlag"),
            ...
            booleanPreset("misc-place", "Установка стойки", "Управляет установкой стоек для брони гостями.", "minecraft:smooth_stone_slab", "MiscPlaceFlag", "Разрешить", "Запретить"),
            booleanPreset("misc-break", "Разрушение стойки", "Управляет разрушением стоек для брони гостями.", "minecraft:stone_axe", "MiscBreakFlag", "Разрешить", "Запретить"),
            number("misc-cap", "Лимит стоек", "Задаёт лимит стоек для брони на участке.", "minecraft:chainmail_chestplate", "MiscCapFlag"),

            collection("use", "Взаимодействие", "Настраивает список блоков, доступных гостям для взаимодействия.", "minecraft:dark_oak_door", "UseFlag", PlotFlagCollectionAddMode.COMMAND_AND_MENU),
            collection("place", "Установка", "Настраивает список блоков, доступных гостям для установки.", "minecraft:scaffolding", "PlaceFlag", PlotFlagCollectionAddMode.COMMAND_AND_MENU),
            collection("break", "Разрушение", "Настраивает список блоков, доступных гостям для разрушения.", "minecraft:iron_pickaxe", "BreakFlag", PlotFlagCollectionAddMode.COMMAND_AND_MENU),

            booleanPreset("tile-drop", "Дроп блоков", "Переключает выпадение предметов при разрушении блоков.", "minecraft:bundle", "TileDropFlag", "Включить", "Выключить"),
            ...
            booleanPreset("hanging-break", "Разрушение рамок и картин", "Управляет разрушением рамок и картин гостями.", "minecraft:glow_item_frame", "HangingBreakFlag", "Разрешить", "Запретить"),
            booleanPreset("edit-sign", "Редактирование табличек", "Управляет редактированием табличек гостями.", "minecraft:glow_ink_sac", "EditSignFlag", "Разрешить", "Запретить"),

            booleanPreset("device-interact", "Простейшие механизмы", "Управляет активацией простых механизмов гостями.", "minecraft:heavy_weighted_pressure_plate", "DeviceInteractFlag", "Разрешить", "Запретить"),
            ...
            preset(
                key = "fly",
                title = "Возможность полёта",
                description = "Переключает полёт при входе на участок.",
                itemModel = "minecraft:feather",
                className = "FlyFlag",
                options = listOf(
                    PlotFlagOption("Не задано", "none"),
                    PlotFlagOption("Включить", "enabled"),
                    PlotFlagOption("Выключить", "disabled")
                )
            ),
            ...
            booleanPreset("crop-grow", "Рост посевов", "Переключает рост посевов на участке.", "minecraft:wheat_seeds", "CropGrowFlag", "Включить", "Выключить"),
            ...
            booleanPreset("copper-oxide", "Окисление меди", "Переключает окисление меди на участке.", "minecraft:weathered_copper", "CopperOxideFlag", "Включить", "Выключить"),
            booleanPreset("coral-dry", "Высыхание кораллов", "Переключает высыхание кораллов на участке.", "minecraft:dead_tube_coral", "CoralDryFlag", "Включить", "Выключить"),
            ...
            booleanPreset("ice-melt", "Таяние льда", "Переключает таяние льда на участке.", "minecraft:water_bucket", "IceMeltFlag", "Включить", "Выключить"),
            ...
            preset(
                key = "liquid-flow",
                title = "Течение жидкостей",
                description = "Переключает течение жидкостей на участке.",
                itemModel = "minecraft:lava_bucket",
                className = "LiquidFlowFlag",
                options = listOf(
                    PlotFlagOption("Не задано", "none"),
                    PlotFlagOption("Включить", "enabled"),
                    PlotFlagOption("Выключить", "disabled")
            ...
            collection("blocked-cmds", "Команды", "Настраивает список команд, заблокированных на участке.", "minecraft:command_block", "BlockedCmdsFlag", PlotFlagCollectionAddMode.COMMAND_ONLY),
