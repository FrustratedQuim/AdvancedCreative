...
data class PlotFlagDefinition(
    ...
    companion object {
        ...
        val definitions: List<PlotFlagDefinition> = listOf(
            ...
            collection("use", "Взаимодействие", "Настраивает список блоков, доступных гостям для взаимодействия.", "minecraft:lever", "UseFlag", PlotFlagCollectionAddMode.COMMAND_AND_MENU),
