...
class EditCommand(hooker: FunctionHooker) : ExecutableCommand(hooker, PluginCommandType.EDIT) {
    ...
    override fun handle(player: Player, args: Array<out String>) {
        ...
        if (action == null) {
            player.sendRichMessage("<red>Использование: /edit show | /edit reset <all|plugin> | /edit name|lore|component|enchant|tooltip|potion|head|attribute|consumable|death_protection|remainder ...")
            return
        }
