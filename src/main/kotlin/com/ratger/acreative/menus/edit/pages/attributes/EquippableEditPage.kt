...
class EquippableEditPage(
    ...
    private fun buildSlotButton(session: ItemEditSession): Button {
    ...
    private fun buildOverlayButton(session: ItemEditSession): Button {
    ...
    private fun buildModelButton(session: ItemEditSession): Button {
        val explicit = EquippableSupport.explicitSnapshot(session.editableItem)
        val prototype = EquippableSupport.prototypeSnapshot(session.editableItem)
