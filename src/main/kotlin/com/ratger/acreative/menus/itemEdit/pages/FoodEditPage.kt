...
class FoodEditPage(
    ...
    private fun buildRandomTeleportButton(player: Player, session: ItemEditSession, openBack: (Player, ItemEditSession) -> Unit): ru.violence.coreapi.bukkit.api.menu.button.Button {
    ...
    private fun buildAnimationButton(player: Player, session: ItemEditSession, openBack: (Player, ItemEditSession) -> Unit): ru.violence.coreapi.bukkit.api.menu.button.Button {
        val options = listOf(
