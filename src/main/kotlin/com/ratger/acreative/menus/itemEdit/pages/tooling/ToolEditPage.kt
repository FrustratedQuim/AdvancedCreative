package com.ratger.acreative.menus.itemEdit.pages.tooling
...
class ToolEditPage(
    ...
    private fun buildMaxDurabilityButton(player: Player, session: ItemEditSession): Button {
    ...
    private fun buildDamageButton(player: Player, session: ItemEditSession): Button {
    ...
    private fun buildMiningSpeedButton(player: Player, session: ItemEditSession): Button {
    ...
    private fun buildDamagePerBlockButton(player: Player, session: ItemEditSession): Button {
