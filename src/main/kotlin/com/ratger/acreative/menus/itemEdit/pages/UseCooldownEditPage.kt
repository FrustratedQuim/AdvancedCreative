...
class UseCooldownEditPage(
    ...
    private fun buildSecondsButton(player: Player, session: ItemEditSession): ru.violence.coreapi.bukkit.api.menu.button.Button {
    ...
    private fun buildGroupButton(player: Player, session: ItemEditSession): ru.violence.coreapi.bukkit.api.menu.button.Button {
