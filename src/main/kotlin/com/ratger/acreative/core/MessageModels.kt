...
object MessageCatalog {
    val templates: Map<MessageKey, String> = mapOf(
        ...
        MessageKey.ERROR_PAINT_USER_BANNED to "<dark_red>▍ <#FF1500>Вам заблокирован доступ к /paint",
        MessageKey.PAINT_USER_BANNED to "<dark_green>▍ <#00FF40>Игрок <#7BFF00>%player% <#00FF40>успешно забанен в /paint",
        MessageKey.PAINT_USER_UNBANNED to "<dark_green>▍ <#00FF40>Игрок <#7BFF00>%player% <#00FF40>успешно разбанен в /paint",
