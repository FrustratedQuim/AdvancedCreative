...
object MessageCatalog {
    val templates: Map<MessageKey, String> = mapOf(
        ...
        MessageKey.USAGE_JAR to "<dark_red>▍ <#FF1500>Используйте /jar <игрок> [-const]",
        ...
        MessageKey.ERROR_JAR_HAND_NOT_EMPTY to "<dark_red>▍ <#FF1500>Главная рука должна быть пустой.",
        ...
        MessageKey.ERROR_JAR_OWNER_MISMATCH to "<dark_red>▍ <#FF1500>Эту банку может установить только владелец.",
