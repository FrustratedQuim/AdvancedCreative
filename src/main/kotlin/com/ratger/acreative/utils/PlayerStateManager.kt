...
class PlayerStateManager(
    ...
    enum class PlayerStateType {
        ...
        fun conflicts(): Set<PlayerStateType> = when (this) {
            CRAWLING -> setOf(DISGUISED, FROZEN, GLIDING, LAYING, SITTING, GRABBING, GRABBED, JARRED)
            DISGUISED -> setOf(CRAWLING, FROZEN, LAYING, SITTING, GRABBING, GRABBED, JARRED)
            FROZEN -> setOf(DISGUISED, LAYING, SITTING, GRABBING, GRABBED, JARRED)
            GLIDING -> setOf(CRAWLING, FROZEN, LAYING, SITTING, GRABBING, GRABBED, JARRED)
            PISSING -> setOf(FROZEN, GRABBING, GRABBED, JARRED)
            LAYING -> setOf(CRAWLING, FROZEN, DISGUISED, GLIDING, SITTING, GRABBING, GRABBED, JARRED)
            SITTING -> setOf(CRAWLING, FROZEN, DISGUISED, GLIDING, LAYING, GRABBING, GRABBED, JARRED)
            GRABBING -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, GRABBED, JARRED)
            GRABBED -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, GRABBING, JARRED)
            JARRED -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, GRABBING, GRABBED, CUSTOM_SIZE)
            CUSTOM_SIZE -> setOf(CRAWLING, DISGUISED, LAYING, SITTING, GRABBING, GRABBED, JARRED)
            CUSTOM_EFFECT,
            CUSTOM_HEALTH,
            CUSTOM_DAMAGE,
            HIDDEN_BY_SOMEONE,
