...
class PlayerStateManager(
    ...
    enum class PlayerStateType {
        ...
        fun conflicts(): Set<PlayerStateType> = when (this) {
            CRAWLING -> setOf(DISGUISED, FROZEN, GLIDING, LAYING, SITTING, PAINTING, GRABBING, GRABBED, JARRED)
            DISGUISED -> setOf(CRAWLING, FROZEN, LAYING, SITTING, PAINTING, GRABBING, GRABBED, JARRED)
            FROZEN -> setOf(DISGUISED, LAYING, SITTING, PAINTING, GRABBING, GRABBED, JARRED)
            GLIDING -> setOf(CRAWLING, FROZEN, LAYING, SITTING, PAINTING, GRABBING, GRABBED, JARRED)
            PISSING -> setOf(FROZEN, PAINTING, GRABBING, GRABBED, JARRED)
            LAYING -> setOf(CRAWLING, FROZEN, DISGUISED, GLIDING, SITTING, PAINTING, GRABBING, GRABBED, JARRED)
            SITTING -> setOf(CRAWLING, FROZEN, DISGUISED, GLIDING, LAYING, PAINTING, GRABBING, GRABBED, JARRED)
            PAINTING -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, CUSTOM_SIZE, GRABBING, GRABBED, JARRED)
            GRABBING -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, PAINTING, GRABBED, JARRED)
            GRABBED -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, PAINTING, GRABBING, JARRED)
            JARRED -> setOf(CRAWLING, DISGUISED, FROZEN, GLIDING, PISSING, LAYING, SITTING, PAINTING, GRABBING, GRABBED, CUSTOM_SIZE)
            CUSTOM_SIZE -> setOf(CRAWLING, DISGUISED, LAYING, SITTING, PAINTING, GRABBING, GRABBED, JARRED)
            CUSTOM_EFFECT,
            CUSTOM_HEALTH,
            CUSTOM_DAMAGE,
            HIDDEN_BY_SOMEONE,
